...
@react.component
let make = () => {
  <Flex height={100.0->#pct->all}>
    <Box display=[xxs(#none), md(#block)] p={6->all} className=wrapper xxs=#6> {`Box`->s} </Box>
    <Box display={#flex->all} justifyContent={#center->all} alignItems={#center->all} xxs=#12 md=#6>
